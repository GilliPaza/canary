local mType = Game.createMonsterType("instance|Cobra Assassin")
local monster = {}
...
monster.loot = {
	{ name = "platinum coin", chance = 75000, maxCount = 3 },
	{ name = "knife", chance = 7875 },
	{ name = "cobra crest", chance = 5812 },
	{ id = 3307, chance = 5812 }, -- scimitar
	{ name = "protection amulet", chance = 5625 },
	{ name = "heavy machete", chance = 4875 },
	{ name = "bone sword", chance = 3750 },
	{ name = "machete", chance = 1687 },
	{ name = "carlin sword", chance = 1687 },
	{ id = 23533, chance = 1267 }, -- ring of red plasma
}
