local mType = Game.createMonsterType("instance|Cobra Scout")
local monster = {}
...
monster.loot = {
	{ name = "platinum coin", chance = 55500, maxCount = 9 },
	{ name = "earth arrow", chance = 14617, maxCount = 28 },
	{ name = "stone skin amulet", chance = 5100 },
	{ name = "gold ingot", chance = 4312, maxCount = 1 },
	{ name = "cheesy figurine", chance = 10350 },
	{ name = "opal", chance = 17850, maxCount = 5 },
	{ name = "cobra crest", chance = 11587 },
	{ name = "small emerald", chance = 2250, maxCount = 2 },
	{ name = "violet gem", chance = 975 },
	{ name = "yellow gem", chance = 2295 },
	{ name = "green gem", chance = 907 },
	{ id = 3039, chance = 3600 }, -- red gem
	{ name = "sacred tree amulet", chance = 3825 },
	{ name = "green crystal shard", chance = 1597 },
	{ id = 23533, chance = 555 }, -- ring of red plasma
}
