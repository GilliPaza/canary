local mType = Game.createMonsterType("instance|Cobra Vizier")
local monster = {}
...
monster.loot = {
	{ name = "platinum coin", chance = 64110, maxCount = 4 },
	{ name = "terra rod", chance = 32250 },
	{ name = "snakebite rod", chance = 15727 },
	{ name = "cobra crest", chance = 12097 },
	{ name = "terra hood", chance = 10282 },
	{ name = "cyan crystal fragment", chance = 8103 },
	{ name = "terra boots", chance = 7260 },
	{ id = 281, chance = 6652 }, -- giant shimmering pearl (green)
	{ id = 3039, chance = 4837 }, -- red gem
	{ name = "emerald bangle", chance = 4237 },
	{ name = "gemmed figurine", chance = 3630 },
	{ name = "green crystal fragment", chance = 2422 },
	{ name = "red crystal fragment", chance = 2422 },
	{ name = "serpent sword", chance = 1815 },
	{ name = "violet crystal shard", chance = 1815 },
	{ name = "green gem", chance = 1207 },
	{ name = "onyx chip", chance = 1207, maxCount = 3 },
}
