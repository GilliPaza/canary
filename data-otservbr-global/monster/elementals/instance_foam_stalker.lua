local mType = Game.createMonsterType("instance|Foam Stalker")
local monster = {}
...
monster.loot = {
	{ name = "platinum coin", chance = 75000, maxCount = 50 },
	{ name = "halberd", chance = 8268 },
	{ name = "strong mana potion", chance = 7296 },
	{ name = "orichalcum pearl", chance = 7296 },
	{ name = "spike sword", chance = 6225 },
	{ name = "combat knife", chance = 5253 },
	{ name = "flotsam", chance = 5155 },
	{ name = "white pearl", chance = 4863 },
	{ id = 3130, chance = 4766 }, -- twigs
	{ id = 3289, chance = 4766 }, -- staff
	{ name = "remains of a fish", chance = 4474 },
	{ name = "glacier shoes", chance = 4280 },
	{ name = "coral branch", chance = 3696 },
	{ name = "soul orb", chance = 3696 },
	{ id = 3027, chance = 3501 }, -- black pearl
	{ name = "small diamond", chance = 2918 },
	{ name = "small emerald", chance = 2432, maxCount = 2 },
	{ id = 281, chance = 1653 }, -- giant shimmering pearl (green)
	{ name = "terra boots", chance = 3806 },
	{ name = "mercenary sword", chance = 3125 },
	{ name = "knight legs", chance = 2736 },
	{ name = "violet gem", chance = 2541 },
}
